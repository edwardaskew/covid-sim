...
void DoInfect(int, double, int, int, bitmap_state const* state, param const& P, person* Hosts, household const* Households); //added int as argument to InfectSweep to record run number: ggilani - 15/10/14
...
void DoDetectedCase(int, double, unsigned short int, int, bitmap_state const* state, param const& P, person* Hosts, household const* Households);
void DoCase(int, double, unsigned short int, int, bitmap_state const* state, param const& P, person* Hosts, household const* Households);
void DoFalseCase(int, double, unsigned short int, int, bitmap_state const* state, param const& P, person* Hosts, household const* Households);
...
void DoTreatCase(int, unsigned short int, int, bitmap_state const* state, param const& P, person* Hosts, household const* Households);
void DoProph(int, unsigned short int, int, bitmap_state const* state, param const& P, person* Hosts, household const* Households);
void DoProphNoDelay(int, unsigned short int, int, int, bitmap_state const* state, param const& P, person* Hosts, household const* Households);
int DoVacc(int, unsigned short int, bitmap_state const* state, param const& P, person* Hosts, household const* Households);
void DoVaccNoDelay(int, unsigned short int, bitmap_state const* state, param const& P, person* Hosts, household const* Households);
//SEVERITY ANALYSIS
