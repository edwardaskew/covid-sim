...
void SetupModel(char*, char*, char*, char*, param& P, person *& Hosts, household *& Households, popvar& State);
void SetupPopulation(char*, char*, char*, param& P, person *& Hosts, household *& Households, popvar& State);
